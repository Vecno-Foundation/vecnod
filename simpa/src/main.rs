...
fn apply_args_to_consensus_params(args: &Args, params: &mut Params) {
    ...
    if args.testnet {
        ...
        params.current_ghostdag_k = k;
        params.current_mergeset_size_limit = k as u64 * 10;
        params.current_max_block_parents = u8::max((0.66 * k as f64) as u8, 10);
        params.current_target_time_per_block = (1000.0 / args.bps) as u64;
        params.current_merge_depth = (params.current_merge_depth as f64 * args.bps) as u64;
        params.current_coinbase_maturity = (params.current_coinbase_maturity as f64 * f64::max(1.0, args.bps * args.delay * 0.25)) as u64;
        ...
        if args.daa_legacy {
            ...
            params.current_difficulty_window_size = (params.current_difficulty_window_size as f64 * args.bps) as usize;
        } else {
    ...
    if args.test_pruning {
        ...
        params.current_difficulty_window_size = 64;
        ...
        params.current_ghostdag_k = 10;
        params.current_finality_depth = 100;
        params.current_merge_depth = 64;
        params.current_mergeset_size_limit = 32;
        params.current_pruning_depth = 100 * 2 + 50;
