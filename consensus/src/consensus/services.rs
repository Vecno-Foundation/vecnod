...
impl ConsensusServices {
    pub fn new(
        ...
        let window_manager = DualWindowManager::new(
            ...
            params.current_target_time_per_block,
            params.starlight.target_time_per_block,
            params.starlight_activation,
            params.current_difficulty_window_size,
            params.starlight.sampled_difficulty_window_size as usize,
            params.min_difficulty_window_size,
            params.starlight.difficulty_sample_rate,
            params.prior_past_median_time_window_size(),
            params.sampled_past_median_time_window_size(),
            params.starlight.past_median_time_sample_rate,
        );
