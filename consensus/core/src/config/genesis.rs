...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xc6, 0x94, 0x54, 0xcd, 0x39, 0x0e, 0x28, 0x25, 0x9b, 0x83, 0x88, 0x0a, 0x25, 0x64, 0x9d, 0x29, 0xeb, 0xcc, 0xe4, 0x12, 0x27,
        0xa4, 0xa5, 0xbb, 0x85, 0x1a, 0x24, 0x32, 0x16, 0x78, 0x1f, 0x31,
    ]),
    version: 0,
