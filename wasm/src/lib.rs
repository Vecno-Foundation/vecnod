...
- **RPC API** — [RPC interface bindings](vecno_wrpc_wasm::client) for the Vecnod using WebSocket (wRPC) connections.
...
framework please see the releases section of the Vecnod
